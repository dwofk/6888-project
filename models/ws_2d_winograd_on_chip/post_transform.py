    ...
    def tick(self):
        ...
        if self.bias_chn.valid(): # should only ever be valid once
            ...
            if (self.iteration == 0):    # get M_00
                ...
                self.y00 += m
                self.y01 += m
                self.raw_stats['alu_comp'] += 2
                self.raw_stats['rf_rd'] += 2
                self.raw_stats['rf_wr'] += 2
                self.iteration += 1
                ...
                self.raw_stats['rf_wr'] -= 1 # send y00 immediately w/o writing to rf
                ...
                self.raw_stats['rf_wr'] -= 1 # send y01 immediately w/o writing to rf
                ...
                self.raw_stats['rf_wr'] -= 1 # send y10 immediately w/o writing to rf
                ...
                self.raw_stats['rf_wr'] -= 1 # send y11 immediately w/o writing to rf
            #self.iteration += 1
